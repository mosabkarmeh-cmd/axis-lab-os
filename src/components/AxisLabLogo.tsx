          ...
          <div className="space-y-2 mt-1">
            ...
            <div className="flex items-center justify-center gap-4 pt-3 border-t border-zinc-900/60 text-[9px] text-zinc-500 font-sans max-w-sm mx-auto">
              <div className="flex flex-col items-center gap-1">
                <span className="text-xs text-[#c59257]">🛠️</span>
                <span className="text-[8px] scale-90">ماكينات</span>
              </div>
              <div className="h-4 w-[1px] bg-zinc-850"></div>
              <div className="flex flex-col items-center gap-1">
                <span className="text-xs text-[#c59257]">🪵</span>
                <span className="text-[8px] scale-90">خشب</span>
              </div>
              <div className="h-4 w-[1px] bg-zinc-850"></div>
              <div className="flex flex-col items-center gap-1">
                <span className="text-xs text-[#c59257]">💎</span>
                <span className="text-[8px] scale-90">بليكسي</span>
              </div>
              <div className="h-4 w-[1px] bg-zinc-850"></div>
              <div className="flex flex-col items-center gap-1">
                <span className="text-xs text-[#c59257]">🌸</span>
                <span className="text-[8px] scale-90">ديكورات</span>
              </div>
              <div className="h-4 w-[1px] bg-zinc-850"></div>
              <div className="flex flex-col items-center gap-1">
                <span className="text-xs text-[#c59257]">⚡</span>
                <span className="text-[8px] scale-90">قص ليزر</span>
              </div>
            </div>
          </div>
        )}
